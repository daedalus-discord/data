...
export default {
        ...
        callouts: [
            {
                style: "info",
                content:
                    "This permission does not allow users to edit channel overrides; that is part of [[ManageRoles]].",
            },
        ],
    },
    ManageGuild: {
    ...
    SendTTSMessages: {
        ...
        description:
            "Allows users to use <code>/tts</code> which sends a message that is read aloud to everyone focused on the channel.",
    },
    ManageMessages: {
        ...
        callouts: [
            {
                style: "info",
                content:
                    "To create forum posts and talk in text and text-in-voice channels, users need [[SendMessages]].",
            },
        ],
    },
    ...
    { name: string; description: string; callouts?: { style: string; content: string }[] }
>;
